...
folder = 'C:/Users/lucya/MSC_PROJECT/Volunteer/Prostate/';
...
load(fullfile(dict_folder, 'blochdict_prostate_20mm_101_transverse.mat'));
...
save(fullfile(recon_folder, 'recon_results_prostate_20mm_101.mat'), 'svd_images', 'D', 'dict0', 'idx', 'R', 'match_images', 'idx2', 'c', 'N', 'Qmaps');