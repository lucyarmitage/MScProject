...
% Load data  
komamri_folder = 'C:/Users/LucyA/MSC_PROJECT/Dictionary';
load(fullfile(komamri_folder, 'komamri_signal4.mat'));
...
% Load trajectory
load('C:/Users/LucyA/MSC_PROJECT/Dictionary/komamri_traj.mat');  
...
load(fullfile(dict_folder, 'blochdict_10mm_101_short.mat'));
...
%save(fullfile(recon_folder, '10mm_501_random_short.mat'), 'svd_images', 'D', 'dict0', 'idx', 'R', 'match_images', 'idx2', 'c', 'N', 'Qmaps');
